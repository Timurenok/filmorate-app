...
ALTER TABLE film_mark ADD CONSTRAINT fk_film_id_mark FOREIGN KEY(film_id) REFERENCES films(id) ON DELETE CASCADE;
ALTER TABLE film_mark ADD CONSTRAINT fk_user_id_mark FOREIGN KEY(user_id) REFERENCES users(id) ON DELETE CASCADE;
